...
<html>
   ...
   <body>
      <h3>Um novo contato foi realizado, segue os dados abaixo:</h3>

      <h4>Nome: {{ $data['name'] }}</h4>
      <h4>Email: {{ $data['email'] }}</h4>
      <h4>Tel: {{ $data['tel'] }}</h4>
      <h4>Mensagem: {{ $data['msg'] }}</h4>
   </body>
                                          ...
                                          {{--<tr>--}}
                                             {{--<td width="30" height="30" align="right">--}}
                                                {{--<div class="imgpop">--}}
                                                   ...
                                                   {{--<img src="email/simples/img/facebook.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">--}}
                                                   {{--</a>--}}
                                                {{--</div>--}}
                                             {{--</td>--}}
                                             ...
                                             {{--<td width="30" height="30" align="center">--}}
                                                {{--<div class="imgpop">--}}
                                                   {{--<a target="_blank" href="#">--}}
                                                   {{--<img src="email/simples/img/twitter.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">--}}
                                                   {{--</a>--}}
                                                {{--</div>--}}
                                             {{--</td>--}}
                                             {{--<td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>--}}
                                             {{--<td width="30" height="30" align="center">--}}
                                                {{--<div class="imgpop">--}}
                                                   {{--<a target="_blank" href="#">--}}
                                                   {{--<img src="email/simples/img/linkedin.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">--}}
                                                   {{--</a>--}}
                                                {{--</div>--}}
                                             {{--</td>--}}
                                          {{--</tr>--}}
                                       ...
                                       {{--<tbody>--}}
                                          {{--<tr>--}}
                                             {{--<td width="169" height="45" align="center">--}}
                                                {{--<div class="imgpop">--}}
                                                   {{--<a target="_blank" href="#">--}}
                                                   {{--<img src="email/simples/img/logo.png" alt="" border="0" width="169" height="45" style="display:block; border:none; outline:none; text-decoration:none;">--}}
                                                   {{--</a>--}}
                                                {{--</div>--}}
                                             {{--</td>--}}
                                          {{--</tr>--}}
                           ...
                           {{--<tbody>--}}
                              {{--<tr>--}}
                                 ...
                                 {{--<td align="center" st-image="banner-image">--}}
                                    {{--<div class="imgpop">--}}
                                       {{--<a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="email/simples/img/banner.png" class="banner"></a>--}}
                                    {{--</div>--}}
                                 {{--</td>--}}
                              {{--</tr>--}}
                           {{--</tbody>--}}
                                       ...
                                       {{--<tbody>--}}
                                          ...
                                          {{--<tr>--}}
                                             {{--<td width="100%" align="center" class="devicewidth">--}}
                                                {{--<img src="email/simples/img/icon1.png" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">--}}
                                             {{--</td>--}}
                                          {{--</tr>--}}
                                          {{--<!-- end of image2 -->--}}
                                          {{--<tr>--}}
                                                   ...
                                                   {{--<tbody>--}}
                                                      ...
                                                      {{--<tr>--}}
                                                         {{--<td width="290" height="160" align="center" class="devicewidth">--}}
                                                            {{--<img src="email/simples/img/ipad.png" alt="" border="0" width="290" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">--}}
                                                         {{--</td>--}}
                                                      {{--</tr>--}}
                                                      {{--<!-- Content -->--}}
                                                      {{--<tr>--}}
