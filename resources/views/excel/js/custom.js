...
(function($) {
    ...
    THEMEMASCOT.initialize = {
        ...
        init: function() {
            ...
            THEMEMASCOT.initialize.TM_pricingTableHoverActivate();
        ...
        /* ------------------------------ Hash Forwarding  ---------------------- */
        /* ---------------------------------------------------------------------- */
        TM_pricingTableHoverActivate: function() {
            var $pricing_table = $('.pricing-table-container .pricing-table');
            $pricing_table.on('mouseover', function(e) {
                $pricing_table.removeClass('featured');
        ...
        TM_instagramFeed: function() {
            $('.instagram-feed-carousel').each(function() {
                ...
                var instagramFeed = new Instafeed({
                    ...
                    resolution: current_div.data('resolution'), //low_resolution
                    limit: current_div.data('limit'), //9
